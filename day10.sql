...
INSERT INTO `animals` VALUES (1,'dog'),(2,'cat'),(3,'penguin'),(4,'lax'),(5,'whale'),(6,'ostrich'),(7,'kangaroo'),(10,'panda'),(11,'tiger'),(12,'owl');
...
--
-- Temporary table structure for view `product1`
--

DROP TABLE IF EXISTS `product1`;
/*!50001 DROP VIEW IF EXISTS `product1`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `product1` (
...
INSERT INTO `products` VALUES (1,'mouse',240,5),(2,'Memory',140,6),(3,'ZIP drive',150,4),(4,'Floppy disk',5,6),(5,'Monitor',240,1),(6,'DVD drive',180,2),(7,'CD drive',90,2),(8,'Printer',270,3),(9,'Toner cartridge',66,3),(10,'DVD burner',180,2),(11,'Printer',40,7),(12,'Toner cartridge',54,7),(13,'DVD burner',78,7);
/*!40000 ALTER TABLE `products` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `productscopy`
--

DROP TABLE IF EXISTS `productscopy`;
/*!50001 DROP VIEW IF EXISTS `productscopy`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `productscopy` (
  `Code` tinyint NOT NULL,
...
--
-- Final view structure for view `product1`
--

/*!50001 DROP TABLE IF EXISTS `product1`*/;
/*!50001 DROP VIEW IF EXISTS `product1`*/;
...
/*!50001 VIEW `product1` AS select `products`.`Code` AS `code`,`products`.`Name` AS `product`,`manu`.`Name` AS `manufacturer` from (`manu` join `products` on((`products`.`Code` = `manu`.`Code`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `productscopy`
--

/*!50001 DROP TABLE IF EXISTS `productscopy`*/;
/*!50001 DROP VIEW IF EXISTS `productscopy`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `productscopy` AS select `products`.`Code` AS `Code`,`products`.`Name` AS `Name`,`products`.`Price` AS `Price`,`products`.`Manufacturer` AS `Manufacturer` from `products` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2018-01-19 11:39:25
